function [mc] = gasturbine(N,capacity)

N;              % Economic lifetime (planning period) in years
ahr = 11800;     % Average heate rate BTU/kWh
ic = 350;      % Investment cost $/kW
fc = 3.5;       % $/MBtu
FOM = 1;       % Fixed O&M Cost $/kW/Year
VOM = 5;        % Variable O&M Cost $/MWh
a = 0.08;        % Fuel Cost and O&M Escalation %/year
